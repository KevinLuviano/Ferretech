...
<<<<<<< Updated upstream:html/confirmacion.html
            
<<<<<<< HEAD:html/confirmacion.php
            <a href="inicio.php" class="btn btn-primary w-100 py-2 fw-bold">Volver a la Tienda</a>
=======
            <a href="inicio.html" class="btn btn-primary w-100 py-2 fw-bold">Volver a la Tienda</a>
=======
>>>>>>> Stashed changes:html/confirmacion.php
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            if (ultimaCompra) {
                ...
                if (elTotal) elTotal.textContent = `$${parseFloat(ultimaCompra.total).toFixed(2)} MXN`;
            } else {
                ...
                if (tarjeta) {
                    tarjeta.innerHTML = `
                        ...
                        <a href="checkout.php" class="btn btn-warning w-100 mt-3 py-2 fw-bold">Ir al Checkout</a>
                    `;
                }
            }
        });
